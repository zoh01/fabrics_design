...
import 'package:fabrics_design/features/presentation/screens/cart_screen/widgets/check_out_container.dart';
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: ZohSizes.md, vertical: ZohSizes.sm),
              child: Row(
                children: [
                  // Search Field
                  Expanded(
